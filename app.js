...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const fadeInElements = document.querySelectorAll('.gradient-text, .subtitle, .description');
    ...
    // Add floating animation to icons (original code remains for other icons)
    const floatingIcons = document.querySelectorAll('.bot-icon, .discord-icon'); //This line is redundant now.
